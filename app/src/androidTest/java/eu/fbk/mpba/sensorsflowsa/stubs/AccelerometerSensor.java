...
public class AccelerometerSensor extends SensorComponent<Long, float[]> implements SensorEventListener {

    private SensorManager _sensorMan;
    private Sensor _sAcc;
    private String _name;

    public AccelerometerSensor(DevicePlugIn<Long, float[]> d, Context context) {
