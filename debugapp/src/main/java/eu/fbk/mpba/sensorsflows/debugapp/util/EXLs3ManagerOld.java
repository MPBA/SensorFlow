 ...
 */
@SuppressLint("NewApi")
public class EXLs3ManagerOld {

    public static interface DataDelegate {
        void receive(EXLs3ManagerOld sender, Packet p);
    }

    public static interface StatusDelegate {
        void idle(EXLs3ManagerOld sender);
        void listening(EXLs3ManagerOld sender);
        void connecting(EXLs3ManagerOld sender, BluetoothDevice device, boolean secureMode);
        void connected(EXLs3ManagerOld sender, String deviceName);
        void connectionFailed(EXLs3ManagerOld sender);
        void connectionLost(EXLs3ManagerOld sender);
    }
    ...
    // Debugging
    private static final String TAG = EXLs3ManagerOld.class.getSimpleName();

    // Name for the SDP record when creating server socket
    private static final String NAME_SECURE = EXLs3ManagerOld.class.getSimpleName() + "Secure";
    private static final String NAME_INSECURE = EXLs3ManagerOld.class.getSimpleName() + "Insecure";
     ...
     *
     */
    public EXLs3ManagerOld(StatusDelegate statusDelegate, DataDelegate dataDelegate) {
     ...
     *
     */
    public EXLs3ManagerOld(StatusDelegate statusDelegate, DataDelegate dataDelegate, BluetoothAdapter adapter) {
    ...
    class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != BTSrvState.CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (EXLs3ManagerOld.this) {
                        switch (mState) {
                            case LISTENING:
                            case CONNECTING:
    ...
    class ConnectedThread extends Thread {
        ...
        private final EXLs3ManagerOld caller;

        public ConnectedThread(EXLs3ManagerOld caller, BluetoothSocket socket, String socketType) {
