...
public class FlowsMan<TimeT, ValueT> implements
        IUserInterface<DevicePluginX<TimeT, ValueT>, SensorComponent<TimeT, ValueT>, OutputPlugin<TimeT, ValueT>>,
    ...
    protected EventCallback<IUserInterface<DevicePluginX<TimeT, ValueT>, SensorComponent<TimeT, ValueT>, OutputPlugin<TimeT, ValueT>>
...
//            Log.v(LOG_TAG, "Switching off async " + sensor.toString());
     ...
     */
    @Override
    public void setOnStateChanged(EventCallback<IUserInterface<DevicePluginX<TimeT, ValueT>, SensorComponent<TimeT, ValueT>, OutputPlugin<TimeT, ValueT>>, EngineStatus> callback) {
